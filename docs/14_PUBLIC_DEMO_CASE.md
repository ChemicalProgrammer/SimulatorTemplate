...
The console can create **Public 13-unit demo** from the Cases panel. It is a complete, runnable demonstration Case for testing the editor, playback, buffers, seeded micro-stops, and reliability events without adding confidential plant data.
...
Therefore, its MTBF, MTTR, geometry, buffer, speed-factor, pack configuration, and equivalent-flow values are deliberately marked as transparent **synthetic assumptions**. They must not be used as a design limit, a plant benchmark, or a CAPEX recommendation.
